...
<?php echo $this->Form->create('SuppliesProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Supplies Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SuppliesProduct.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SuppliesProduct.id'))); ?></li>
